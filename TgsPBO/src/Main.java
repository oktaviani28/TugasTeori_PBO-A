import TgsTeoriPBO.Pecahan;
import TgsTeoriPBO.Matrik;

public class Main {
    public static void main(String[] args) {
        Pecahan pecahan1 = new Pecahan(3, 5);
        Pecahan pecahan2 = new Pecahan(2, 6);

        System.out.println("TgsTeoriPBO.Pecahan 1: " + pecahan1);
        System.out.println("TgsTeoriPBO.Pecahan 2: " + pecahan2);
